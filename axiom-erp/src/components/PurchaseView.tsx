...
import { Supplier, PurchaseOrder, Product, POItem } from '../types';
import {
  ShoppingCart,
  Search,
  Plus,
                    ...
                    <tbody className="divide-y divide-slate-200 font-mono">
                      {poCart.map((item, idx) => (
                        <tr key={idx} className="hover:bg-slate-50 text-slate-700">
                          ...
                          <td className="py-1 px-2 border-r border-slate-200 text-right font-bold text-emerald-800">{item.qty}</td>
